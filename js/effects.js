...
greeting2.innerHTML = "I'm a UI/UX Strategist, Front-End Developer,";
greeting3.innerHTML = "Illustrator and Green Drink Enthusiast.";
...
aboutP2.innerHTML = 'My name is Jordan Kimura and I earned a B.A. in Digital Design and an M.B.A. with an emphasis in Strategic Marketing while playing college tennis. Passionate about creating meaningful things that are enriching, I strive to implement well-branded creative assets and content deliverables.';
...
resumeBtn.innerHTML = '<a class="a_resume" href="https://bit.ly/2fi6gR6" target="_blank">View Resume </a><i class="fa fa-file-pdf-o" aria-hidden="true"></i>';
